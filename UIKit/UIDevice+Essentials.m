...
+ (NSString *)nameOfHardwareIdentifier:(NSString *)identifier {
    ...
    dispatch_once(&onceToken, ^{
        ...
        names = @{
                  ...
                  @"iPad11,6": @"iPad 8",  //! Wi-Fi, 2020
                  @"iPad11,7": @"iPad 8",  //! Cellular, 2020
                  ...
                  @"iPad11,1": @"iPad Mini 5", //! Wi-Fi, 2019
                  @"iPad11,2": @"iPad Mini 5", //! Cellular, 2019
                  ...
                  @"iPad13,1": @"iPad Air 4", //! Wi-Fi, 2020
                  @"iPad13,2": @"iPad Air 4", //! Cellular, 2020
